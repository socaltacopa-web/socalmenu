const defaultMenuItems = [
  ...
  { id: "salmon-tacos", name: "Salmon tacos", category: "TACOS", price: 7, desc: "Grilled salmon tacos. Choose one taco or a three taco plate.", image: "socal-salmon-tacos.jpg", toppingCategoryIds: ["taco-toppings"], variants: [{ name: "1 Salmon Taco", price: 7 }, { name: "3 Salmon Tacos", price: 18 }] },
  { id: "small-tacos", name: "Small Tacos", category: "TACOS", price: 10, desc: "Three small tacos. Choose chicken, pork, chorizo, ground beef, steak, or salmon.", image: "", toppingCategoryIds: ["taco-toppings"], variants: [{ name: "Chicken", price: 10 }, { name: "Pork", price: 10 }, { name: "Chorizo", price: 10 }, { name: "Ground Beef", price: 10 }, { name: "Steak", price: 12 }, { name: "Salmon", price: 12 }] },
  { id: "burritos", name: "Burritos", category: "BURRITOS", price: 11, desc: "Choose JR, small, or large burrito with your meat.", image: "https://148597173.cdn6.editmysite.com/uploads/1/4/8/5/148597173/HAEMTJ4ZP25ACOT7VT6ZS3QU.png?width=640&optimize=medium", toppingCategoryIds: ["no-shell-toppings"], variants: [{ name: "JR Chicken", price: 11 }, { name: "JR Pork", price: 11 }, { name: "JR Chorizo", price: 12 }, { name: "JR Ground Beef", price: 12 }, { name: "JR Al Pastor", price: 12 }, { name: "JR Barbacoa", price: 13 }, { name: "JR Tongue", price: 13 }, { name: "JR Steak", price: 15 }, { name: "JR Salmon", price: 15 }, { name: "JR Lamb", price: 15 }, { name: "JR Steak and Shrimp", price: 15 }, { name: "Small Chicken", price: 12 }, { name: "Small Pork", price: 12 }, { name: "Small Chorizo", price: 13 }, { name: "Small Ground Beef", price: 13 }, { name: "Small Al Pastor", price: 13 }, { name: "Small Barbacoa", price: 14 }, { name: "Small Tongue", price: 14 }, { name: "Small Steak", price: 16 }, { name: "Small Salmon", price: 16 }, { name: "Small Lamb", price: 16 }, { name: "Small Steak and Shrimp", price: 16 }, { name: "Large Chicken", price: 16 }, { name: "Large Pork", price: 16 }, { name: "Large Chorizo", price: 17 }, { name: "Large Ground Beef", price: 17 }, { name: "Large Al Pastor", price: 17 }, { name: "Large Barbacoa", price: 19 }, { name: "Large Tongue", price: 19 }, { name: "Large Steak", price: 20 }, { name: "Large Salmon", price: 20 }, { name: "Large Lamb", price: 20 }, { name: "Large Steak and Shrimp", price: 20 }] },
...
const defaultToppingCategories = [
  ...
  { id: "quesadilla-meats", name: "Quesadilla Meat", options: ["No meat", "Chicken", "Pork", "Chorizo", "Ground Beef", "Al Pastor", "Vegan Chorizo", "Barbacoa", "Tongue", "Steak", "Salmon", "Lamb", "Steak and Shrimp"] },
...
const currentAppVersion = "2026-08-12-salmon-picture-v73";
const currentMenuVersion = "socal-tacos-menu-2026-08-12-salmon-picture";
...
setInterval(() => {
  if (cart.length === 0) retryPendingOrderDeliveries();
}, 30000);

setInterval(() => {
  if (cart.length === 0) pullSharedOrderHistory();
}, 60000);
