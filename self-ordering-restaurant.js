...
function applyLanguage() {
  ...
  $("#simpleMenuViewBtn").textContent = t("simpleMenu");
...
function showPage(pageName) {
  ...
  $("#simpleMenuPage").classList.toggle("hidden", !isSimpleMenuPage);
  ...
  $("#simpleMenuViewBtn").classList.toggle("active", isSimpleMenuPage);
...
$("#simpleMenuViewBtn").addEventListener("click", () => showPage("simpleMenu"));
